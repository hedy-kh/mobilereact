...
import { StyleSheet, KeyboardAvoidingView, Image, TextInput, Dimensions, TouchableOpacity, Text, View } from 'react-native';
import Axios from 'axios';
import { AsyncStorage } from 'react-native';

const BaseUrl = 'http://192.168.223.125:8000/api/user/create'; // Replace with your actual backend IP and port
...
const SignUpScreen = ({ navigation }) => {
  ...
  const handleCreateAccount = async () => {
    try {
      ...
      if (response.data.success) {
        ...
        // If signup is successful, navigate to OTPVerificationScreen
  ...
  return (
    <KeyboardAvoidingView style={[styles.container, { marginTop: height * -0.1 }]} behavior="padding">
      ...
      />
      <TouchableOpacity
        style={[styles.button, styles.createAccountButton, { width: width - 40 }]}
